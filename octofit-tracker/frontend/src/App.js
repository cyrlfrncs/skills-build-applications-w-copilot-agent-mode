          ...
          <Route path="/" element={
            <div className="card mt-4">
              <div className="card-body">
                ...
                <Link to="/activities" className="btn btn-success me-2">View Activities</Link>
                <Link to="/leaderboard" className="btn btn-info me-2">Leaderboard</Link>
                <Link to="/teams" className="btn btn-warning me-2">Teams</Link>
                <Link to="/users" className="btn btn-secondary me-2">Users</Link>
